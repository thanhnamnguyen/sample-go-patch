...
const (
	TestService_GetTest_FullMethodName = "/tests.TestService/GetTest"
)
...
func (c *testServiceClient) GetTest(ctx context.Context, in *Test, opts ...grpc.CallOption) (*Test, error) {
...
func (UnimplementedTestServiceServer) GetTest(context.Context, *Test) (*Test, error) {
...
func _TestService_GetTest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TestServiceServer).GetTest(ctx, req.(*Test))
	}
...
var TestService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "tests/nullable_test.proto",
}
